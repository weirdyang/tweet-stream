...
namespace TweetStream.Core.Services
{
    ...
    {
        private readonly ITweetQueue<FilteredStreamTweetV2EventArgs> _taskQueue;
        ...
        public EventListener(
            ITweetQueue<FilteredStreamTweetV2EventArgs> taskQueue,
    ...
    TweetConfiguration tweetConfigurateion)
        ...
        private async void HandleTweet(object sender, FilteredStreamTweetV2EventArgs e)
        {
                ...
                await _taskQueue.QueueTweetAsync(e);
